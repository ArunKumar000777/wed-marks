...
const Hero = () => {
    return (
        <section>
            <div className="flex items-center justify-between h-screen px-10 lg:px-40 md:px-20 ">
                <div className="w-[500px] h-[600px] ">
                    <img
                        src={heroImage}
                        alt="heroImage"
                        className="h-full w-full object-cover rounded-tl-[60px] rounded-br-[60px] hover:scale-105 border-white border-8 transition ease-in-out duration-300"
                    />
                </div>
            ...
            {/* WHAT WE DO */}
            <div className="flex justify-center w-full px-40 mt-32">
                <div className="pr-24">
